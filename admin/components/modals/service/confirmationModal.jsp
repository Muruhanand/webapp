            ...
            <div
                ...
                <div
                    ...
                    <div class="relative bg-white rounded-lg shadow-xl p-6">
                        ...
                        <div class="mt-4 mb-6">
                            <p id="main-message" class="text-gray-700">Are you sure you want to delete this service? This action cannot be undone.</p>
                            <p id="sub-message" class="text-sm text-gray-500 mt-2">All associated data will be permanently removed from the system.</p>
                        </div>
                        ...
                        <div class="flex items-center justify-end gap-3">
                            <button type="button" onclick="closeDeleteModal()"
                                ...
                                Cancel</button>
                            <form action="/JADProject/admin/api/service/deleteService.jsp"
                                method="POST">
                                <input name="serviceId" id="deleteServiceId"
                                    value="" class="hidden" />
                                <button type="submit"
