...
<body>
	...
	<h3 class="display-3 text-center">Book an Appointment with us
		today!</h3>
	<form action="appointmentProcess.jsp" method="post">
		...
		%>
		<div class="mb-3">
			<label>Cleaning Category:</label> <select name="categoryOptions"
				id="categoryOptions" class="form-select"
				onchange="populateServices()">
		...
		<div class="mb-3">
			<label>Service:</label> <select id="serviceOptions"
				class="form-select" name="serviceOptions"></select>
		</div>
		<script>
		...
		%>
		<div class="mb-3">
			<label for="dateSelector" class="form-label">Select Date</label> <input
				type="date" class="form-control" id="dateSelector"
				name="selectedDate" required>
		</div>
		<div class="mb-3">
			<label for="timeSelectorStart" class="form-label">From:</label> <input
				type="time" class="form-control" id="timeSelectorStart"
				name="selectedTimeStart" min="09:00" max="18:00" required>
		</div>
		<div class="mb-3">
			<label for="timeSelectorEnd" class="form-label">To:</label> <input
				type="time" class="form-control" id="timeSelectorEnd"
				name="selectedTimeEnd" min="09:00" max="18:00" required>
		</div>
