...
<body>
    ...
    <h3 class="display-3 text-center">Update Booking</h3>
    ...
    try {
        ...
        String sqlStr = "UPDATE bookings SET booking_date = ?, booking_start_time = ?, booking_end_time = ? WHERE booking_id = ?";
        ...
        if (rowsAffected > 0) {
            out.println("<div class='alert alert-success'>Booking updated successfully.</div>");
        } else {
