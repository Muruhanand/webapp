			...
			<div id="register" class="form-container" style="display: none;">
				<form action="registerprocess.jsp" method="post">
					<ul class="register-form" id="tabform">
						<li><label for="first_name">First Name:</label> <input
							type="text" id="first_name" name="first_name" required></li>
						<li><label for="last_name">Last Name:</label> <input
							type="text" id="last_name" name="last_name" required></li>
						<li><label for="email">Email:</label> <input type="email"
							id="email" name="email" required></li>
						<li><label for="phone_number">Phone Number:</label> <input
							type="text" id="phone_number" name="phone_number" required></li>
						<li><label for="address">Address:</label> <input type="text"
							id="address" name="address" required></li>
						<li><label for="password">Password:</label> <input
							type="password" id="newpassword" name="password" required></li>
					</ul>
					<button type="submit" name="btnSubmit">Login</button>
				</form>
			</div>
