        ...
        <table class="table table-borderless">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 3px solid #24034C;">
                    <td style="border-bottom: 3px solid #24034C;">
                        <input type="checkbox" class="form-check-input" name="selectedItems" value="<%=serviceId%>" id="deleteItem<%=serviceId%>">
                    </td>
                    <td><%=serviceName%></td>
                    <td>$<%=totalPrice%></td>
                    <td><%=bookingDate%></td>
                    <td>
                        <button class="btn btn-primary btn-sm me-2" type="button" onclick="location.href='editBooking.jsp?bookingid=<%=bookingid%>'">Edit</button>
                        <button class="btn btn-danger btn-sm" type="button" onclick="location.href='deleteBooking.jsp?bookingid=<%=bookingid%>'">Delete</button>
                    </td>
                </tr>
                <%
                }
                ...
                <tr>
                    <td colspan="5" class="text-end">
                        <button class="btn btn-success" type="button" onclick="checkOut()">Check Out</button>
                    </td>
                </tr>
            </tbody>
        </table>
